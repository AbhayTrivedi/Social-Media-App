import { Avatar, Button, Dialog, Typography, CircularProgress } from '@mui/material';
...
const Account = () => {
   ...
   const { message, error: likeError, loading: deleteLoading } = useSelector((state) => state.like);
         ...
         <div className='account'>
            <div className="accountLeft">
               {posts && posts.length > 0 ? (
                  ...
                  <Typography variant="h6">You don't have any post yet</Typography>
               )}
            </div>
            ...
            <div className="accountRight">
               ...
               {isAccountDelete && deleteLoading ? <CircularProgress style={{ color: "red", margin: "2vmax" }} /> :
                  <Button
                     variant='text'
